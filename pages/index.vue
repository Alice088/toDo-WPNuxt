	...
	>
		<article class="flex-col
									  ...
									  rounded-tr-[10%]
										...
										items-center
									  laptop:flex
										[&_blockquote]:text-BlackOlive
										[&_blockquote]:bg-BabyPink
									  [&_blockquote]:p-3
										[&_blockquote]:rounded-[5px]
										[&_blockquote]:text-[18px]
										[&_blockquote]:flex
										[&_blockquote]:flex-col
										[&_blockquote]:justify-center
										[&_blockquote]:gap-y-5
										[&_blockquote]:text-center
										[&_blockquote]:max-w-[50%]
										dark:[&_blockquote]:bg-BlackOlive
										dark:[&_blockquote]:text-BabyPink
										col-start-1
										col-end-2
										bg-[url('@/assets/images/backgrounds/WomanWithPearlEarring.webp')]
										bg-cover
										transition
										duration-300
										hidden"
			...
			<form v-show="showFirstStep"
			      ...
			      action=""
						...
						class="grid
								   ...
								   [&_input]:dark:text-BlackOlive
								   [&_input]:placeholder:text-BabyPink
								   [&_input]:placeholder:dark:text-BlackOlive
									 col-start-1
									 col-end-3
									 laptop:col-start-2
									 laptop:grid-rows-[35%_62%_3%]
									 grid-rows-[24%_73%_3%]
									 ...
									 bg-BabyPink"
			>
				<svg xmlns="http://www.w3.org/2000/svg" width="300" height="200" viewBox="0 0 2000 944">
				...
				>
					<div>
						<label> min — current — max — valid — error </label>
						<TheInput type="email"
						          autocomplete="off"
						          placeholder="Email"
					...
					<TheButton @click="isRegistration = !isRegistration">
						<p class="dark:text-BabyPink cursor-pointer">
							{{ isRegistration ? "Already have an account?" : "don't have an account?" }}
						</p>
					</TheButton>
				</div>

				<p class="dark:text-BabyPink">
					{{ isRegistration ? "this is Registration" : "this is Authentication" }}
				</p>
			</form>
		</transition>
		...
		<transition name="fadeAnimation" appear>
			...
			>
				...
				>
					...
					<img src="@/assets/images/backgrounds/CatsPicturedInFamousArt7.jpg" alt="Avatar">
					...
					<theInput type="text"
					          ...
					          maxlength="20"
										class="dark:bg-BlackOlive
													 ...
													 placeholder:text-BlackOlive
													 placeholder:dark:text-BabyPink
													 p-2
													 text-start
					                 bg-BabyPink
					                 text-BlackOlive
